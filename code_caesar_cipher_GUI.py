...
class CaesarCipher(tk.Frame):
    def __init__(self, root):
        ...
        #justassigning main_frame instead of self so it would easy to read
    ...
    #empty string is allowed..if we have put a key and use backspace then normally it is not allowed but now its allowed
